...
export const followSucces = (userId: number): FollowActionType => ({type: FOLLOW, userId})
export const unfollowSucces = (userId: number): UnFollowActionType => ({type: UNFOLLOW, userId})
